...
def format_phrase(phrase):
    """
    Format a phrase as a sentence - starting with a captial and ending with a single full stop.
    >>> format_phrase('hello')
    'Hello.'
    >>> format_phrase('It is an ex parrot.')
    'It is an ex parrot.'
    >>> format_phrase('one more test')
    'One more test.'
    """
    if phrase[-1] == ".":
        stop = ""
        ...
        stop = "."
    return phrase[0].upper() + phrase[1 : ] + stop
